...
public:
  ...
  void reset();
protected:
  virtual void onSendRawData(const toolkit::Buffer::Ptr& buffer) = 0;
...
private:
  ...
  ////////////Chunk////////////
 std::unordered_map<int, RtmpPacket> _mapChunkData;
  //////////Rtmp parser//////////
  std::string _strRcvBuf;
  std::function<void()> _nextHandle;
};
